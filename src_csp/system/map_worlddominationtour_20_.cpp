#include "map_worlddominationtour_20_.hpp"

uint32_t * Map_WorldDominationTour_20_::_vt06(uint32_t *this, uint32_t *a2, int a3)
{
    int v3; // edi
    v3 = *(this + 1) + 8 * a3;
    ComPtr::Constructor(a2);
    *a2 = &rc_ptr<WorldDominationTour::Territory>::`vftable';
    ComPtr::Set(a2, *(uint32_t *)(v3 + 4));
    return a2;
}

char  Map_WorldDominationTour_20_::_vt01(int *this, int a2)
{
    int v2; // esi
    int v3; // edx
    uint32_t *v4; // ecx
...
char  Map_WorldDominationTour_20_::_vt02(uint8_t *this, int a2, uint32_t *a3)
{
    int v3; // ebp
    uint32_t *v5; // eax
    uint32_t *v6; // esi
    ...
    *v6 = &rc_ptr<WorldDominationTour::Territory>::`vftable';
    v6 += 2;
    --v9;
    while ( v9 );
    v6 = a3 + 1;
...
int  Map_WorldDominationTour_20_::_vt03(int this)
{
...
int  Map_WorldDominationTour_20_::_vt04(int this, int a2)
{
    int result; // eax
    int v3; // edx
    uint32_t *i; // ecx
...
unsigned int  Map_WorldDominationTour_20_::_vt05(int this, int a2)
{
    if ( *(uint8_t *)(this + 12) )
...
uint32_t * Map_WorldDominationTour_20_::_vt00(uint32_t *Block, char a2)
{
...
char * Map_WorldDominationTour_20_::sub_76A610(uint32_t *Block, char a2)
{
    int v3; // eax
    char *v4; // ebp
    uint32_t *v5; // esi
    ...
    do
    v5 -= 2;
    *v5 = &rc_ptr<WorldDominationTour::Territory>::`vftable';
    ComPtr::Release(v5);
    --v7;
    while ( v7 );
    if ( (a2 & 1) != 0 )
    ...
    *Block = &rc_ptr<WorldDominationTour::Territory>::`vftable';
