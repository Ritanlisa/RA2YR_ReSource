#include "vectorclass_techno.hpp"

char  VectorClass_Techno::_vt02(void *this, int a2, uint32_t *a3)
{
    uint32_t *v4; // edi
    int v6; // ecx
    int i; // eax
...
void  VectorClass_Techno::_vt03(int this)
{
...
int  VectorClass_Techno::_vt04(int this, uint32_t *a2)
{
    int result; // eax
    int v3; // edx
    uint32_t *i; // ecx
...
unsigned int  VectorClass_Techno::_vt05(int this, int a2)
{
    if ( *(uint8_t *)(this + 12) )
