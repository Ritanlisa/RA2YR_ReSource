#include "vectorclass_pbg.hpp"

// 0x00558230
int  VectorClass_PBG::Count(uint32_t *this, int a2)
{
    return *(uint32_t *)(*(this + 1) + 4 * a2);
}

// 0x00558240
char  VectorClass_PBG::Get(int *this, int a2)
{
    int v2; // esi
    int v3; // edx
    uint32_t *v4; // eax
...
char  VectorClass_PBG::_vt02(void *this, int a2, uint32_t *a3)
{
    uint32_t *v4; // edi
    int v6; // ecx
    int i; // eax
...
// 0x00558330
void  VectorClass_PBG::Set(int this)
{
...
int  VectorClass_PBG::_vt04(int this, uint32_t *a2)
{
    int result; // eax
    int v3; // edx
    uint32_t *i; // ecx
...
unsigned int  VectorClass_PBG::_vt05(int this, int a2)
{
    if ( *(uint8_t *)(this + 12) )
...
uint32_t * VectorClass_PBG::_vt00(uint32_t *Block, char a2)
{
    void *v3; // eax
    v3 = (void *)*(Block + 1);
