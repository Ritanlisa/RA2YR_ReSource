#include "vectorclass_pae.hpp"

// 0x007B4310
int  VectorClass_PAE::Count(uint32_t *this, int a2)
{
    return *(uint32_t *)(*(this + 1) + 4 * a2);
}

// 0x007B4320
char  VectorClass_PAE::Get(int *this, int a2)
{
    int v2; // esi
    int v3; // edx
    uint32_t *v4; // eax
...
char  VectorClass_PAE::_vt02(void *this, int a2, uint32_t *a3)
{
    uint32_t *v4; // edi
    int v6; // ecx
    int i; // eax
...
// 0x007B4410
void  VectorClass_PAE::Set(int this)
{
...
int  VectorClass_PAE::_vt04(int this, uint32_t *a2)
{
    int result; // eax
    int v3; // edx
    uint32_t *i; // ecx
...
unsigned int  VectorClass_PAE::_vt05(int this, int a2)
{
    if ( *(uint8_t *)(this + 12) )
...
uint32_t * VectorClass_PAE::_vt00(uint32_t *Block, char a2)
{
    void *v3; // eax
    v3 = (void *)*(Block + 1);
