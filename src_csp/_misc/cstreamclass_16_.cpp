#include "cstreamclass_16_.hpp"

int  CStreamClass_16_::_vt06(uint32_t *this, int a2)
{
    return *(uint32_t *)(*(this + 1) + 4 * a2);
}

char  CStreamClass_16_::_vt01(int *this, int a2)
{
    int v2; // esi
    int v3; // edx
    uint32_t *v4; // eax
...
char  CStreamClass_16_::_vt02(void *this, int a2, uint32_t *a3)
{
    uint32_t *v4; // edi
    int v6; // ecx
    int i; // eax
...
void  CStreamClass_16_::_vt03(int this)
{
...
int  CStreamClass_16_::_vt04(int this, uint32_t *a2)
{
    int result; // eax
    int v3; // edx
    uint32_t *i; // ecx
...
unsigned int  CStreamClass_16_::_vt05(int this, int a2)
{
    if ( *(uint8_t *)(this + 12) )
...
uint32_t * CStreamClass_16_::_vt00(uint32_t *Block, char a2)
{
    void *v3; // eax
    v3 = (void *)*(Block + 1);
