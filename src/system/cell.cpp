...
CellClass::CellClass()
    ...
    , blockageState(0)
    , terrainOverlayType0(0)
    , terrainOverlayType1(0)
    , terrainOverlayType2(0)
    , terrainOverlayType3(0)
    , terrainOverlayType4(0)
    , terrainOverlayType5(0)
    , terrainOverlayType6(0)
    , m_tube_index(-1)
    , passageDirection1(0)
    , passageDirection2(0)
    , m_height(0)
    ...
    , m_flags(CellFlags::Empty)
{
    ...
    std::memset(padding_144, 0, sizeof(padding_144));
}
