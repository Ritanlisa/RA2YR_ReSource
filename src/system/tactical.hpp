...
public:
    ...
    uint32_t        m_field_D64;
    uint32_t        m_field_D68;
    uint32_t        m_field_D6C;
    uint32_t        m_field_D70;
    uint32_t        m_field_D74;
    uint32_t        m_field_D78;
    bool            m_field_D7C;
    bool            redrawing;
    uint32_t        m_field_D80;
    uint32_t        m_field_D84;
    uint32_t        m_field_D88;
    uint32_t        m_field_D8C;
    uint32_t        m_field_D90;
    uint32_t        m_field_D94;
    uint32_t        m_field_D98;
    uint32_t        m_field_D9C;
    uint32_t        mouseFrameIndex;
    uint32_t        startTime;
    uint32_t        m_field_DA8;
    uint32_t        m_field_DAC;
    float           floats[12];
    RectangleStruct m_field_DE4;
    uint32_t        m_field_DF4;
    double          m_field_DF8;
    uint32_t        m_field_E00;
    uint32_t        m_field_E04;
    double          m_field_E08;
    uint32_t        m_field_E10;
    uint32_t        m_field_E14;
