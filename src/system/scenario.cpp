...
ScenarioClass::ScenarioClass() noexcept
    ...
    , ScenarioClass_field_bool_34B5(false)
    , ScenarioClass_field_bool_34B6(false)
    , ScenarioClass_field_bool_34B7(false)
    , playerSideIndex(-1)
    ...
    , initTime(0)
    , stage(0)
    , ScenarioClass_field_35A2(false)
    , ScenarioClass_field_35A3(0)
    , parTimeEasy(0)
    , parTimeMedium(0)
    , parTimeDifficult(0)
    , ls640BriefLocX(0)
