...
HRESULT __stdcall VoxelAnimClass::GetClassID(CLSID* class_id) { return E_NOTIMPL; }
HRESULT __stdcall VoxelAnimClass::Save(IStream* stream, int clear_dirty) { return S_OK; }
