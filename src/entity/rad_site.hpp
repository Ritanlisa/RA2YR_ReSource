...
public:
    ...
    virtual int objectSize() const override { return sizeof(RadSiteClass); }

    // 0x65B4C0 SetBaseCell
    void SetBaseCell(CellStruct* cell) {}
    // 0x65B4B0 GetSpread
    int GetSpread() const { return 0; }
    // 0x65B4D0 SetSpread
    void SetSpread(int cells) {}
    // 0x65B4F0 SetRadLevel
    void SetRadLevel(int level) {}
    // 0x65B510 GetRadLevel
    int GetRadLevel() const { return 0; }
    // 0x65B530 Add
    void Add(int radLevel) {}
    // 0x65B580 Activate
    void Activate() {}
    // 0x65B8F0 GetRadLevelAt
    int GetRadLevelAt(CellStruct* cell) { return 0; }
    // 0x65B9C0 Radiate
    void Radiate() {}
    // 0x65BB50 Deactivate
    void Deactivate() {}
