...
UnitClass::UnitClass() noexcept
    : cargoCount(static_cast<int>(-1))  // +0x6C0, IDA: *(this+0x6C0) = -1
    ...
    , isCarryallDeploying(false)    // +0x6D2, IDA: *(BYTE*)(this+0x6D2) = 0
    , TerrainPalette(false)      // +0x6D3, IDA: *(BYTE*)(this+0x6D3) = 0
    , carryallState(static_cast<int>(-1))  // +0x6D4, IDA: *(this+0x6D4) = -1
