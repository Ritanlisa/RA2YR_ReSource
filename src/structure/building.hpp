...
public:
    ...
    virtual uint32_t canRecruitTeamMember() { return 0; }
    ...
    RectangleStruct                       field_rect_63C;
    CoordStruct                           field_coord_64C;
    int32_t                               field_int_658;
    uint32_t                              field_65C;
    bool                                  HasPower;
    bool                                  IsOverpowered;
    ...
    int32_t                               field_int_6FC;
    int16_t                               field_short_700;
