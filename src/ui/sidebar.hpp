...
struct CameoDataStruct
{
    ...
    uint32_t         field_10;               // 0x10: unknown — YRpp: unknown_10
...
struct TabDataStruct
{
    ...
    uint8_t          field_3D;               // 0x3D: unknown (YRpp: unknown_3D)
    uint8_t          field_3E;               // 0x3E: unknown (YRpp: unknown_3E)
    uint8_t          field_3F;               // 0x3F: unknown (YRpp: unknown_3F)
    uint32_t         field_40;               // 0x40: unknown (YRpp: unknown_40)
    int32_t          TopRowIndex;            // 0x44: scroll position — topmost visible row
    uint32_t         field_48;               // 0x48: unknown — scroll-related (YRpp: unknown_48)
    uint32_t         field_4C;               // 0x4C: unknown (YRpp: unknown_4C)
    uint32_t         field_50;               // 0x50: unknown (YRpp: unknown_50)
...
public:
    ...
    bool             needsRedrawAll;             // 0x3E64 (YRpp: unknown_bool_53A8)
    ...
    uint32_t         DiplomacyHouseStates[kMaxDiplomacyHouses];   // 0x3F08 (YRpp: unknown_544C)
    uint32_t         DiplomacyHousePowers[kMaxDiplomacyHouses];   // 0x3F28 (YRpp: unknown_546C)
    uint32_t         DiplomacyHouseAlliances[kMaxDiplomacyHouses]; // 0x3F48 (YRpp: unknown_548C)
    uint32_t         DiplomacyHouseSurrenders[kMaxDiplomacyHouses]; // 0x3F68 (YRpp: unknown_54AC)
    uint32_t         DiplomacyHouseCaptures[kMaxDiplomacyHouses];  // 0x3F88 (YRpp: unknown_54CC)
    uint32_t         DiplomacyHouseCreditsSpent[kMaxDiplomacyHouses]; // 0x3FA8 (YRpp: unknown_54EC)
    uint8_t          diplomacyDrawingState;     // 0x3FC8 (YRpp: unknown_550C)
    int32_t          DiplomacyNumHouses;        // 0x3FCC

    bool             stripClassDrawn;           // 0x3FD0 (YRpp: unknown_bool_5514)
    bool             stripClassEnabled;         // 0x3FD1 (YRpp: unknown_bool_5515)
