...
int TechnoClass::processDamageAnimation(); // 0x41B7D0
uint32_t* TechnoClass::HasOnlyOneGarrisonSlot(); // 0x41B7F0
int TechnoClass::updateWeaponCooldown(); // 0x41B840
int TechnoClass::checkAmmo(); // 0x41B860
char TechnoClass::CreateWarheadDamageEffect(); // 0x41BC30
int TechnoClass::ClearArrays(); // 0x5F99E0
void TechnoClass::TechnoClass::ProcessBorderTower(); // 0x6ED4D0
uint32_t* TechnoClass::Update(); // 0x6F3F40
int TechnoClass::Mission_RepairDispatch(); // 0x6F4AB0
char TechnoClass::TechnoClass::FinishDeploy(); // 0x6F6CA0
void* TechnoClass::TechnoClass::SelectAutoTarget_Start_AU(); // 0x6F8DF0
int* TechnoClass::TechnoClass::GetFiringAngle(); // 0x6FDA00
char TechnoClass::ProcessCapture(); // 0x7014A0
int TechnoClass::TechnoClass::ReceiveDamage_Shield(); // 0x701900
void TechnoClass::PickAlternateTarget(); // 0x708E00
char TechnoClass::TechnoClass::EnteredOpenTopped(); // 0x710470
int TechnoClass::TechnoClass::ExitedOpenTopped(); // 0x7104A0
void TechnoClass::GetField(); // 0x731CF0
uint32_t* TechnoClass::TechnoClass::GatherAllBuildings(); // 0x732050
int TechnoClass::TechnoClass::CheckUnitFireConstraints(); // 0x740FD0
void TechnoClass::TechnoClass::ProcessSpecialUnitDeployCrush(); // 0x7416A0
void* TechnoClass::TechnoClass::SelectAutoTargetWithGarrison(); // 0x743190
int TechnoClass::TechnoClass::MarkCellImpassable(); // 0x7441B0
char TechnoClass::TechnoClass::ClearCellImpassable(); // 0x744210
char TechnoClass::TechnoClass::ProcessUnitSelfDestruct(); // 0x746100
