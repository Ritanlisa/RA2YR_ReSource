...
public:
    ...
    int32_t             lastCommands[3];                  // 0xD4 (offset 212)
    gamemd::VectorClass<TechnoClass*> radioLinks;         // 0xE0 (offset 224, 16 bytes: vtable/Items/Capacity/IsInitialized/IsAllocated)
