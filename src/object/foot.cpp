...
extern void* FootClass_vftable[1];
...
FootClass::FootClass() noexcept
{
    ...
    m_current_map_coords          = CellStruct{};
    m_last_map_coords             = CellStruct{};
    m_last_jumpjet_map_coords     = CellStruct{};
    m_current_jumpjet_map_coords  = CellStruct{};
    ...
    m_path_delay_timer     = TimerStruct{};
    m_unknown_int_64C      = 0;
    m_unknown_timer_650    = TimerStruct{};
    m_sight_timer          = TimerStruct{};
    m_blockage_path_timer  = TimerStruct{};
    ...
    const auto vtbl = const_cast<void**>(reinterpret_cast<void* const*>(FootClass_vftable));
