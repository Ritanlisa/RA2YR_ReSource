...
int JumpjetLocomotionClass::StubReturnZero(); // 0x4AF8E0
int JumpjetLocomotionClass::StubReturnZero_0(); // 0x4AF930
bool JumpjetLocomotionClass::CheckPiggybackState(); // 0x4AF970
unsigned int* JumpjetLocomotionClass::InitMovementState(); // 0x4AFB40
bool JumpjetLocomotionClass::StubReturnTrue(); // 0x4AFB80
bool JumpjetLocomotionClass::StubReturnTrue_0(); // 0x4AFC20
unsigned int* JumpjetLocomotionClass::GetCoordinate(); // 0x4AFC90
unsigned int* JumpjetLocomotionClass::GetRenderCoordinate(); // 0x4AFCC0
unsigned int* JumpjetLocomotionClass::ConvertCoordToCell(); // 0x4AFD40
int JumpjetLocomotionClass::CheckWindowsErrorWrapper(); // 0x4AFE00
float* JumpjetLocomotionClass::ComputeVoxelTransform(); // 0x4AFF60
float* JumpjetLocomotionClass::ComputeAudio3DRotation(); // 0x4B0410
int JumpjetLocomotionClass::DispatchVirtualCall(); // 0x4B04D0
char ProcessJumpjetMotion(); // 0x4B0500
char JumpjetLocomotionClass::SetWaypointTarget(); // 0x4B0C40
char JumpjetLocomotionClass::UpdateFacingDirection(); // 0x4B0EF0
int JumpjetLocomotionClass::StubReturnTwo(); // 0x4B4820
int DriveLocomotionClass::ddtor(); // 0x4B4830
int JumpjetLocomotionClass::DispatchCheckState(); // 0x4B4880
char JumpjetLocomotionClass::MoveToChecked(); // 0x4B48D0
bool JumpjetLocomotionClass::IsAtDestination(); // 0x4B4920
char JumpjetLocomotionClass::StubReturnZero_2(); // 0x4B4B00
int JumpjetLocomotionClass::SetByteField(); // 0x4B4BE0
int JumpjetLocomotionClass::SetByteField_0(); // 0x4B4BF0
int JumpjetLocomotionClass::GetField_0x54(); // 0x4B4C00
int JumpjetLocomotionClass::GetField_0x58(); // 0x4B4C10
int JumpjetLocomotionClass::GetField_0x48(); // 0x4B4C20
long DriveLocomotionClass::AddRef(); // 0x4B4CB0
long DriveLocomotionClass::Release(); // 0x4B4CC0
BOOL JumpjetLocomotionClass::GetLinkedLocomotorPointer(); // 0x4B4CD0
int JumpjetLocomotionClass::GetField_0x78(); // 0x4B4D90
long JumpjetLocomotionClass::GetField_0x7C(); // 0x4B4DA0
long JumpjetLocomotionClass::GetField_0x80(); // 0x4B4DB0
unsigned int* JumpjetLocomotionClass::GetSpeedCoordinate(); // 0x4B5B40
...
int JumpjetLocomotionClass::StubReturnZero_3(); // 0x4B63B0
int JumpjetLocomotionClass::StubReturnZero_4(); // 0x4B6400
bool JumpjetLocomotionClass::CheckBaseClassState(); // 0x4B6440
int JumpjetLocomotionClass::SmallStub_4B64D0(); // 0x4B64D0
int JumpjetLocomotionClass::LoadLocomotionFromStream_0(); // 0x4B64E0
BOOL JumpjetLocomotionClass::ShortFunc_4B65F0(); // 0x4B65F0
...
BOOL JumpjetLocomotionClass::ShortFunc_4B66C0(); // 0x4B66C0
int JumpjetLocomotionClass::SmallStub_4B6740(); // 0x4B6740
long JumpjetLocomotionClass::SmallStub_4B6750(); // 0x4B6750
long JumpjetLocomotionClass::SmallStub_4B6760(); // 0x4B6760
int JumpjetLocomotionClass::SmallStub_4B6770(); // 0x4B6770
long JumpjetLocomotionClass::SmallStub_4B6780(); // 0x4B6780
long JumpjetLocomotionClass::SmallStub_4B6790(); // 0x4B6790
wchar_t* LocomotionClass::UpdateAll(); // 0x4C54A0
int JumpjetLocomotionClass::StubReturnZero_7(); // 0x4CCA20
BOOL JumpjetLocomotionClass::ComputeFloatExpression(); // 0x4CCA90
bool JumpjetLocomotionClass::ComputeFloatExpression_0(); // 0x4CCAC0
unsigned int* JumpjetLocomotionClass::GetMovementCoordinate(); // 0x4CCAE0
...
unsigned int* JumpjetLocomotionClass::ShortFunc_4CF940(); // 0x4CF940
float* JumpjetLocomotionClass::ComputeVoxelMatrix(); // 0x4CFB00
char JumpjetLocomotionClass::SynchronizeFacingDirection(); // 0x4CFC10
int FlyLocomotionClass::ddtor(); // 0x4CFC80
int FlyLocomotionClass::BeginMove(); // 0x4CFCC0
int JumpjetLocomotionClass::DispatchVirtualCall_0(); // 0x4CFCF0
int JumpjetLocomotionClass::ClearLocomotionDirty(); // 0x4CFD20
char JumpjetLocomotionClass::ShortFunc_4CFD90(); // 0x4CFD90
bool JumpjetLocomotionClass::DispatchVirtualCall_1(); // 0x4CFDA0
long long JumpjetLocomotionClass::ComputeFloatExpression_1(); // 0x4CFE20
int JumpjetLocomotionClass::StubReturnZero_8(); // 0x4CFE50
...
float* JumpjetLocomotionClass::ComputeAudio3DRotation_0(); // 0x5142A0
BOOL JumpjetLocomotionClass::HasScoreDisplayChanged(); // 0x514C30
BOOL JumpjetLocomotionClass::ComputeFloatExpression_2(); // 0x514C80
unsigned int* JumpjetLocomotionClass::HasScoreDisplayChanged_514CB0(); // 0x514CB0
unsigned int* JumpjetLocomotionClass::HasScoreDisplayChanged_514D10(); // 0x514D10
unsigned int* JumpjetLocomotionClass::SetMovementTarget(); // 0x514D90
unsigned int* JumpjetLocomotionClass::HasScoreDisplayChanged_516320(); // 0x516320
char JumpjetLocomotionClass::UpdateFacingDirection_0(); // 0x516370
int JumpjetLocomotionClass::ClearLocomotionDirty_0(); // 0x516BF0
bool JumpjetLocomotionClass::DispatchVirtualCall_2(); // 0x516C70
char JumpjetLocomotionClass::TryMoveToAdjacentCell(); // 0x516E10
char JumpjetLocomotionClass::RandomizeLocomotionParam(); // 0x516FC0
int HoverLocomotionClass::ddtor(); // 0x517070
int HoverLocomotionClass::BeginMove(); // 0x5170B0
int JumpjetLocomotionClass::SmallStub_517100(); // 0x517100
int JumpjetLocomotionClass::DispatchVirtualCall_3(); // 0x5171C0
bool JumpjetLocomotionClass::IsPositionWithinThreshold(); // 0x517210
int JumpjetLocomotionClass::InitMovementParams(); // 0x54AD30
char JumpjetLocomotionClass::SmallStub_54AE50(); // 0x54AE50
unsigned int* JumpjetLocomotionClass::GetMovementCoordinate_0(); // 0x54AE60
...
char JumpjetLocomotionClass::SynchronizeFacingDirection_0(); // 0x54B6E0
...
bool JumpjetLocomotionClass::CheckCompositeState(); // 0x54D0D0
char JumpjetLocomotionClass::DispatchVirtualCall_4(); // 0x54D930
unsigned int* JumpjetLocomotionClass::GetConditionedCoordinate(); // 0x54D9B0
int JumpjetLocomotionClass::StubReturnZero_9(); // 0x54DA00
int JumpjetLocomotionClass::StubReturnZero_10(); // 0x54DA50
bool JumpjetLocomotionClass::StubReturnTrue_2(); // 0x54DB00
int JumpjetLocomotionClass::LoadLocomotionFromStream_1(); // 0x54DB50
...
BOOL JumpjetLocomotionClass::ShortFunc_54DF70(); // 0x54DF70
int JumpjetLocomotionClass::SmallStub_54DFF0(); // 0x54DFF0
long JumpjetLocomotionClass::SmallStub_54E000(); // 0x54E000
long JumpjetLocomotionClass::SmallStub_54E010(); // 0x54E010
int JumpjetLocomotionClass::SmallStub_54E020(); // 0x54E020
long JumpjetLocomotionClass::SmallStub_54E030(); // 0x54E030
long JumpjetLocomotionClass::SmallStub_54E040(); // 0x54E040
int JumpjetLocomotionClass::CheckState(); // 0x55ABB0
unsigned int* JumpjetLocomotionClass::GetGlobalCoordinate(); // 0x55AC70
void Array::RemoveItemByValue(); // 0x55B880
char JumpjetLocomotionClass::SmallStub_5AFF70(); // 0x5AFF70
unsigned int* JumpjetLocomotionClass::GetMovementCoordinate_1(); // 0x5AFF80
unsigned int* JumpjetLocomotionClass::GetRenderCoordinate_0(); // 0x5AFFE0
int JumpjetLocomotionClass::ShortFunc_5B0060(); // 0x5B0060
int JumpjetLocomotionClass::ConvertCoordToCell_1(); // 0x5B0080
int JumpjetLocomotionClass::SyncMatrixTransformState(); // 0x5B0120
char JumpjetLocomotionClass::UpdateFacingDirection_1(); // 0x5B0170
int JumpjetLocomotionClass::InitMultiFieldArray(); // 0x5B01A0
int MechLocomotionClass::ddtor(); // 0x5B1960
int MechLocomotionClass::BeginMove(); // 0x5B19A0
int JumpjetLocomotionClass::SmallStub_5B19D0(); // 0x5B19D0
...
BOOL JumpjetLocomotionClass::HasFieldStateChanged(); // 0x661F50
bool JumpjetLocomotionClass::CheckCompositeState_0(); // 0x661F90
unsigned int* JumpjetLocomotionClass::GetCoordinate_0(); // 0x661FB0
int JumpjetLocomotionClass::ComputeFloatExpression_3(); // 0x6632E0
int RocketLocomotionClass::ddtor(); // 0x6633D0
int RocketLocomotionClass::BeginMove(); // 0x663410
int JumpjetLocomotionClass::SmallStub_663460(); // 0x663460
...
int JumpjetLocomotionClass::StubReturnZero_12(); // 0x69EFF0
int JumpjetLocomotionClass::StubReturnZero_13(); // 0x69F040
bool JumpjetLocomotionClass::CheckPiggybackState_0(); // 0x69F080
unsigned int* JumpjetLocomotionClass::InitMovementState_0(); // 0x69F250
bool JumpjetLocomotionClass::StubReturnTrue_5(); // 0x69F290
bool JumpjetLocomotionClass::StubReturnTrue_6(); // 0x69F330
unsigned int* JumpjetLocomotionClass::GetCoordinate_1(); // 0x69F3A0
unsigned int* JumpjetLocomotionClass::GetRenderCoordinate_1(); // 0x69F3D0
unsigned int* JumpjetLocomotionClass::ConvertCoordToCell_2(); // 0x69F450
int JumpjetLocomotionClass::CheckWindowsErrorWrapper_1(); // 0x69F510
float* JumpjetLocomotionClass::ComputeVoxelTransform2(); // 0x69F670
float* JumpjetLocomotionClass::ComputeAudio3DRotation_1(); // 0x69FB20
int JumpjetLocomotionClass::DispatchVirtualCall_6(); // 0x69FBE0
char WalkLocomotionClass::SetWaypointTarget(); // 0x6A0310
char JumpjetLocomotionClass::UpdateFacingDirection_2(); // 0x6A05C0
int JumpjetLocomotionClass::SmallStub_6A3E50(); // 0x6A3E50
int ShipLocomotionClass::ddtor(); // 0x6A3E60
int JumpjetLocomotionClass::DispatchCheckState_6A3EB0(); // 0x6A3EB0
char JumpjetLocomotionClass::MoveToChecked_0(); // 0x6A3F00
bool WalkLocomotionClass::IsAtDestination(); // 0x6A3F50
char JumpjetLocomotionClass::StubReturnZero_15(); // 0x6A4130
int JumpjetLocomotionClass::SetByteField_1(); // 0x6A4210
int JumpjetLocomotionClass::SetByteField_2(); // 0x6A4220
int JumpjetLocomotionClass::SmallStub_6A4230(); // 0x6A4230
int JumpjetLocomotionClass::SmallStub_6A4240(); // 0x6A4240
int JumpjetLocomotionClass::SmallStub_6A4250(); // 0x6A4250
long ShipLocomotionClass::AddRef(); // 0x6A4260
long ShipLocomotionClass::Release(); // 0x6A4270
BOOL JumpjetLocomotionClass::GetLinkedLocomotorPointer_0(); // 0x6A4280
int JumpjetLocomotionClass::SmallStub_6A4300(); // 0x6A4300
long JumpjetLocomotionClass::SmallStub_6A4310(); // 0x6A4310
long JumpjetLocomotionClass::SmallStub_6A4320(); // 0x6A4320
...
char JumpjetLocomotionClass::UpdateFacingDirection_3(); // 0x7192C0
int JumpjetLocomotionClass::SetCoordinateField(); // 0x719BF0
int JumpjetLocomotionClass::StubReturnZero_17(); // 0x719C60
HRESULT JumpjetLocomotionClass::InitMultiFieldArray_0(); // 0x719CA0
HRESULT JumpjetLocomotionClass::CheckWindowsErrorWrapper_2(); // 0x719D40
int JumpjetLocomotionClass::SmallStub_719E20(); // 0x719E20
int JumpjetLocomotionClass::UpdateAltitude(); // 0x719E30
int JumpjetLocomotionClass::StubReturnZero_18(); // 0x719E90
int JumpjetLocomotionClass::StubReturnZero_19(); // 0x719EE0
bool JumpjetLocomotionClass::StubReturnTrue_7(); // 0x719F30
int JumpjetLocomotionClass::LoadLocomotionFromStream_3(); // 0x719F80
int JumpjetLocomotionClass::DispatchVirtualCall_7(); // 0x71A090
BOOL JumpjetLocomotionClass::ShortFunc_71A100(); // 0x71A100
int JumpjetLocomotionClass::SmallStub_71A160(); // 0x71A160
long JumpjetLocomotionClass::SmallStub_71A170(); // 0x71A170
long JumpjetLocomotionClass::SmallStub_71A180(); // 0x71A180
int JumpjetLocomotionClass::SmallStub_71A190(); // 0x71A190
long JumpjetLocomotionClass::SmallStub_71A1A0(); // 0x71A1A0
long JumpjetLocomotionClass::SmallStub_71A1B0(); // 0x71A1B0
bool JumpjetLocomotionClass::ShortFunc_728A50(); // 0x728A50
char JumpjetLocomotionClass::StubReturnZero_20(); // 0x728A60
unsigned int* JumpjetLocomotionClass::GetCoordinateConditional_0(); // 0x728A90
...
int JumpjetLocomotionClass::CheckStateWithOverride(); // 0x72A020
bool JumpjetLocomotionClass::IsStateInRange(); // 0x72A060
char JumpjetLocomotionClass::UpdateFacingDirection_4(); // 0x72A0E0
int TunnelLocomotionClass::ddtor(); // 0x72A110
int TunnelLocomotionClass::BeginMove(); // 0x72A150
int JumpjetLocomotionClass::ShortFunc_72A1A0(); // 0x72A1A0
int JumpjetLocomotionClass::ShortFunc_72A1C0(); // 0x72A1C0
BOOL JumpjetLocomotionClass::ShortFunc_72A1E0(); // 0x72A1E0
char JumpjetLocomotionClass::SmallStub_75AB30(); // 0x75AB30
bool JumpjetLocomotionClass::ComputeFloatExpression_4(); // 0x75AB40
unsigned int* JumpjetLocomotionClass::GetMovementCoordinate_2(); // 0x75ABA0
unsigned int* JumpjetLocomotionClass::GetRenderCoordinate_2(); // 0x75AC00
int JumpjetLocomotionClass::DrawVoxelAnimation(); // 0x75AC80
char JumpjetLocomotionClass::ConvertCoordToCell_4(); // 0x75ACB0
int JumpjetLocomotionClass::DispatchVirtualCall_8(); // 0x75ADA0
char JumpjetLocomotionClass::SynchronizeFacingDirection_1(); // 0x75AE00
...
int JumpjetLocomotionClass::SmallStub_75C7E0(); // 0x75C7E0
int JumpjetLocomotionClass::StubReturnZero_22(); // 0x75C850
int JumpjetLocomotionClass::StubReturnZero_23(); // 0x75C8A0
bool JumpjetLocomotionClass::CheckBaseClassState_0(); // 0x75C8E0
int JumpjetLocomotionClass::LoadLocomotionFromStream_4(); // 0x75C920
int JumpjetLocomotionClass::DispatchVirtualCall_10(); // 0x75CA30
bool JumpjetLocomotionClass::IsPositionWithinThreshold_1(); // 0x75CA80
char JumpjetLocomotionClass::SmallStub_75CB20(); // 0x75CB20
unsigned int* JumpjetLocomotionClass::InitMultiFieldArray_1(); // 0x75CB30
long WalkLocomotionClass::AddRef(); // 0x75CB80
long WalkLocomotionClass::Release(); // 0x75CB90
BOOL JumpjetLocomotionClass::ShortFunc_75CBA0(); // 0x75CBA0
int JumpjetLocomotionClass::SetByteField_3(); // 0x75CBC0
int JumpjetLocomotionClass::SmallStub_75CC30(); // 0x75CC30
long JumpjetLocomotionClass::SmallStub_75CC40(); // 0x75CC40
long JumpjetLocomotionClass::SmallStub_75CC50(); // 0x75CC50
int JumpjetLocomotionClass::SmallStub_75CC60(); // 0x75CC60
long JumpjetLocomotionClass::SmallStub_75CC70(); // 0x75CC70
long JumpjetLocomotionClass::SmallStub_75CC80(); // 0x75CC80
