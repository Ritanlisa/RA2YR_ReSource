...
{
    // {4A582741-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A30 -- DriveLocomotionClass::ddtor
    inline constexpr GUID Drive    = { 0x4A582741, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582742-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A40 -- HoverLocomotionClass::ddtor
    inline constexpr GUID Hover    = { 0x4A582742, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582743-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A50 -- TunnelLocomotionClass::ddtor
    inline constexpr GUID Tunnel   = { 0x4A582743, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582744-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A60 -- WalkLocomotionClass::ddtor
    inline constexpr GUID Walk     = { 0x4A582744, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582745-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A70 -- DropPodLocomotionClass::ddtor
    inline constexpr GUID DropPod  = { 0x4A582745, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582746-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A80 -- FlyLocomotionClass::ddtor
    inline constexpr GUID Fly      = { 0x4A582746, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {4A582747-9839-11D1-B709-00A024DDAFD1} @ 0x7E9A90 -- 9th WinMain factory (TClassFactory_TeleportLocomotionClass)
    inline constexpr GUID Teleport = { 0x4A582747, 0x9839, 0x11D1, { 0xB7, 0x09, 0x00, 0xA0, 0x24, 0xDD, 0xAF, 0xD1 } };
    // {55D141B8-DB94-11D1-AC98-006008055BB5} @ 0x7E9AA0 -- MechLocomotionClass::ddtor
    inline constexpr GUID Mech     = { 0x55D141B8, 0xDB94, 0x11D1, { 0xAC, 0x98, 0x00, 0x60, 0x08, 0x05, 0x5B, 0xB5 } };
    // {2BEA74E1-7CCA-11D3-BE14-00104B62A16C} @ 0x7E9AB0 -- ShipLocomotionClass::ddtor
    inline constexpr GUID Ship     = { 0x2BEA74E1, 0x7CCA, 0x11D3, { 0xBE, 0x14, 0x00, 0x10, 0x4B, 0x62, 0xA1, 0x6C } };
    // {92612C46-F71F-11D1-AC9F-006008055BB5} @ 0x7E9AC0 -- JumpjetLocomotionClass::GetClassIdentifier
    inline constexpr GUID Jumpjet  = { 0x92612C46, 0xF71F, 0x11D1, { 0xAC, 0x9F, 0x00, 0x60, 0x08, 0x05, 0x5B, 0xB5 } };
    // {B7B49766-E576-11D3-9BD9-00104B972FE8} @ 0x7E9AD0 -- RocketLocomotionClass::ddtor
