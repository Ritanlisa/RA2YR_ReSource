...
public:
    ...
    virtual HRESULT __stdcall End_Piggyback(ILocomotion** pointer) override { return S_OK; }          // 0x4AF5E0
    virtual bool __stdcall Is_Ok_To_End() override { return false; }                                   // 0x4AF600
    virtual HRESULT __stdcall Piggyback_CLSID(GUID* classid) override { return S_OK; }                // 0x4AF610
    virtual bool __stdcall Is_Piggybacking() override { return false; }                                // 0x4AF630

    // ILocomotion overrides
    virtual bool __stdcall Is_Moving() override { return false; }              // 0x4AFB80
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x4AEFD0
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }513C80

    virtual bool __stdcall Is_Moving() override { return false; }              // 0x513C30
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x513C40
    virtual bool __stdcall Process() override { return false; }                // 0x513E10
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }  // 0x5140E0
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }75A950

    // IPiggyback
    virtual HRESULT __stdcall Begin_Piggyback(ILocomotion* pointer) override { return S_OK; }         // 0x75AB80
    virtual HRESULT __stdcall End_Piggyback(ILocomotion** pointer) override { return S_OK; }          // 0x75AC00
    virtual bool __stdcall Is_Ok_To_End() override { return false; }                                   // 0x75AC40
    virtual HRESULT __stdcall Piggyback_CLSID(GUID* classid) override { return S_OK; }                // 0x75AC50
    virtual bool __stdcall Is_Piggybacking() override { return false; }                                // 0x75AC70

    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x75A8F0
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x758F20
    virtual bool __stdcall Process() override { return false; }                                        // 0x75AE80
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x75C170
    ...
    virtual bool __stdcall Is_Moving_Now() override { return false; }                                  // 0x7593B0
    virtual bool __stdcall Is_Really_Moving_Now() override { return false; }                           // 0x7593C0
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }4CC8B0

    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x4CC9E0
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x4CCA70
    virtual bool __stdcall Process() override { return false; }                                        // 0x4CCAD0
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x4CD3A0
    ...
    virtual Layer __stdcall In_Which_Layer() override { return static_cast<Layer>(0); }                                // 0x4CC9D0
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }661DF0

    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x661F00
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x661F90
    virtual bool __stdcall Process() override { return false; }                                        // 0x661FF0
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x6624B0
    ...
    virtual Layer __stdcall In_Which_Layer() override { return static_cast<Layer>(0); }                                // 0x661EF0
...
public:
    ...
    // IDA 0x54A8E0 — GetClassID: return Jumpjet CLSID {55D58B90-...}
    virtual HRESULT __stdcall GetClassID(CLSID* class_id) override
    {
        if (!class_id) return E_POINTER;
        *class_id = LocomotorCLSID::Jumpjet;
        return S_OK;
    }

    // IDA 0x54A850 — Load: deserialize jumpjet state from stream
    virtual HRESULT __stdcall Load(IStream* stream) override
    {
        if (!stream) return E_POINTER;
        // Read: TurnRate, Speed, Climb, Crash, Height, Accel, Wobbles, Deviation,
        //       NoWobbles, DestinationCoords, IsMoving, CurrentState, LocomotionFacing,
        //       CurrentSpeed, MaxSpeed, CurrentHeight, CurrentWobbles, DestinationReached
        return S_OK;
    }

    // IDA 0x54A850 — Save: serialize jumpjet state to stream
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override
    {
        if (!stream) return E_POINTER;
        // Write all Jumpjet-specific fields to stream
        if (clear_dirty) Dirty = false;
        return S_OK;
    }

    // IPiggyback — IDA 0x54A520
    virtual HRESULT __stdcall Begin_Piggyback(ILocomotion* pointer) override
    {
        // Allow another locomotor to mount this jumpjet unit
        // Stores pointer as Piggybackee
        Piggybackee = pointer;
        return S_OK;
    }

    // IPiggyback — IDA 0x54A5E0
    virtual HRESULT __stdcall End_Piggyback(ILocomotion** pointer) override
    {
        if (pointer) *pointer = Piggybackee;
        Piggybackee = nullptr;
        return S_OK;
    }

    // IPiggyback — IDA 0x54A650
    virtual bool __stdcall Is_Ok_To_End() override
    {
        // Check if it's safe to stop piggybacking
        // Only allowed when jumpjet is grounded or hovering
        return CurrentState == State::Grounded || CurrentState == State::Hovering;
    }

    // IPiggyback — IDA 0x54A670
    virtual HRESULT __stdcall Piggyback_CLSID(GUID* classid) override
    {
        if (!classid) return E_POINTER;
        // Return CLSIDs of locomotor types that can piggyback on this jumpjet
        *classid = LocomotorCLSID::Jumpjet;
        return S_OK;
    }

    // IPiggyback — IDA 0x54A690
    virtual bool __stdcall Is_Piggybacking() override
    {
        return Piggybackee != nullptr;
    }

    // IDA 0x54AC80 — Is_Moving: check if unit is in transit
    ...
    // IDA 0x54AD30 — Destination: get current move target coordinates
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override
    {
        if (!out) return nullptr;
        *out = DestinationCoords;
        return out;
    }

    // IDA 0x54AD90 — Process: main per-frame state machine dispatch
    virtual bool __stdcall Process() override
    {
        // If owner is destroyed or paralyzed, skip processing
        if (!LinkedTo) return false;
        // Check if owner is alive and powered
        if (!LinkedTo->isAliveFlag) return false;

        // Forward to dispatch function based on CurrentState:
        // Grounded  → process ground movement
        // Ascending → gain height, transition to Cruising
        // Cruising  → fly toward DestinationCoords
        // Descending → lose height, transition to Grounded/Crashing
        // Crashing  → uncontrolled descent
        // Hovering  → stay at height, small wobble

        switch (CurrentState)
        {
            case State::Grounded:
                // Move like normal ground unit using FootClass movement
                break;
            case State::Ascending:
                // Increase CurrentHeight by Climb rate per frame
                // When CurrentHeight >= Height, transition to Cruising
                CurrentHeight += static_cast<int32_t>(Climb);
                ...
                break;
            case State::Cruising:
                // Accelerate CurrentSpeed toward MaxSpeed
                if (CurrentSpeed < MaxSpeed)
                    CurrentSpeed += static_cast<double>(Accel);
                if (CurrentSpeed > MaxSpeed)
                    CurrentSpeed = MaxSpeed;
                // Move toward DestinationCoords
                IsMoving = true;
                break;
            case State::Descending:
                // Decrease CurrentHeight by Climb rate
                CurrentHeight -= static_cast<int32_t>(Climb);
                if (CurrentHeight <= 0)
                {
                    CurrentHeight = 0;
                ...
                break;
            case State::Crashing:
                // Decrease CurrentHeight by Crash rate
                CurrentHeight -= static_cast<int32_t>(Crash);
                if (CurrentHeight <= 0)
                {
                    CurrentHeight = 0;
                    CurrentState = State::Grounded;
                ...
                break;
            case State::Hovering:
                // Maintain altitude, apply small wobble oscillation
                if (!NoWobbles)
                {
                    CurrentWobbles += static_cast<double>(Wobbles);
                    if (CurrentWobbles > 2.0) CurrentWobbles -= 2.0;
                }
                break;
            default:
                break;
    ...
    // IDA 0x54B8F0 — Move_To: set movement destination
    ...
    // IDA 0x54B950 — Stop_Moving: halt all movement
    ...
    // IDA 0x54ACA0 — Do_Turn: update unit facing toward direction
    virtual void __stdcall Do_Turn(unsigned short facing) override
    {
        // Update LocomotionFacing toward target facing at TurnRate
        (void)facing;
        // FacingClass::Update rotation toward target
    }

    // IDA 0x54AC60 — In_Which_Layer: jumpjets fly in the air layer
    virtual Layer __stdcall In_Which_Layer() override
    {
        return static_cast<Layer>(1); // Air layer
    }

    // IDA 0x54B9C0 — Mark_All_Occupation_Bits: register/unregister cell occupancy
    virtual void __stdcall Mark_All_Occupation_Bits(int mark) override
    {
        if (!LinkedTo) return;

        // Get current cell from LinkedTo coordinates
        // For each occupied cell: set or clear occupation bit
        // Jumpjets occupy cells at ground level when grounded,
        // otherwise they are in the air and don't block ground movement

        if (CurrentState == State::Grounded || CurrentState == State::Descending)
        {
            // Unit occupies ground cells — mark their occupation bits
            // CellClass::MarkOccupation(LinkedTo->GetCell(), LinkedTo, mark != 0);
        }
        (void)mark;
    }

    // IDA 0x54BAD0 — ILocomotion_B8 (Limbo): remove unit from world temporarily
    virtual void __stdcall ILocomotion_B8() override
    {
        // "Limbo" state — remove unit from all cell occupation
        // Used when unit is being transported, paradropped, etc.
        // Stop movement and clear occupation bits
        IsMoving = false;
        DestinationReached = true;
    }
    ...
    // === Non-virtual helper methods (IDA-confirmed) ===

    // IDA 0x54AD30 — InitMovementParams: load movement settings from type
    void InitMovementParams(FootClass* owner)
    {
        if (!owner) return;
        // Read Jumpjet stats from owner's TechnoType:
        // TurnRate = type->JumpjetTurnRate;
        // Speed = type->JumpjetSpeed;
        // Climb = type->JumpjetClimb;
        // Height = type->JumpjetHeight;
        // Accel = type->JumpjetAccel;
        // Wobbles = type->JumpjetWobbles;
        // Deviation = type->JumpjetDeviation;
        (void)owner;
    }

    // IDA 0x54AEC0 — DispatchLocomotion: state-based per-frame dispatch
    void DispatchLocomotion()
    {
        if (!LinkedTo || !LinkedTo->isAliveFlag) return;

        // Check if ion storm disables jumpjets
        // If owner is parachuted/in limbo, skip movement
        // Dispatch based on CurrentState enum:
        switch (CurrentState)
        {
            case State::Grounded:  break; // handled by base movement
            case State::Ascending: UpdateAltitude(); break;
            case State::Cruising:  MoveToDestination(); break;
            case State::Descending: UpdateAltitude(); break;
            case State::Crashing:  UpdateAltitude(); break;
            case State::Hovering:  break; // stay in place
            default: break;
        }
    }

    // IDA 0x54B4D0 — MoveToDestination: navigate toward target coordinates
    void MoveToDestination()
    {
        if (!LinkedTo) return;
        // Calculate direction vector toward DestinationCoords
        // Apply CurrentSpeed per frame toward target
        // Check if close enough to destination → switch to Descending
        // Apply wobble oscillation if !NoWobbles

        // Compute distance to destination
        int dx = DestinationCoords.X - LinkedTo->location.X;
        int dy = DestinationCoords.Y - LinkedTo->location.Y;
        int dist_sq = dx * dx + dy * dy;

        if (dist_sq < 256) // Close enough
        {
            DestinationReached = true;
            CurrentState = State::Descending;
        }
    ...
    // IDA 0x719E30 — UpdateAltitude: adjust height based on state
    void UpdateAltitude()
    {
        switch (CurrentState)
        {
    ...
    // IDA 0x54B6E0 — SmoothObjectPlacement: lerp unit position for smooth movement
    void SmoothObjectPlacement()
    {
        // Interpolate visual position toward logical position
        // Creates smooth sliding effect for jumpjet units
        if (!LinkedTo) return;
        // UpdateMovementPosition();
    }

    // IDA 0x54DCC0 — ComputeMovementTransform: build combined transform matrix
    float* ComputeMovementTransform(float* out)
    {
        if (!out) return nullptr;
        // Combine: world position + facing rotation + altitude offset + wobble
        std::memset(out, 0, 16 * sizeof(float));
        out[0] = out[5] = out[10] = out[15] = 1.0f;
        return out;
    }

    // IDA 0x4AFF60 — ComputeVoxelTransform: voxel-specific transform matrix
    float* ComputeVoxelTransform(float* out, int key)
    {
        if (!out) return nullptr;
        ComputeMovementTransform(out);
        // Apply voxel-specific rotation and pitch
        (void)key;
        return out;
    }

    // IDA 0x4CF610 — ComputeRotationMatrix: facing direction → rotation matrix
    float* ComputeRotationMatrix(float* out)
    {
        if (!out) return nullptr;
        std::memset(out, 0, 16 * sizeof(float));
        out[0] = out[5] = out[10] = out[15] = 1.0f;
        // Rotate around Z axis by LocomotionFacing.DesiredFacing angle
        return out;
    }

    // IDA 0x4CF830 — CalculateBobOffset: vertical bobbing offset for hover
    void CalculateBobOffset(int* out_x, int* out_y, int* out_z)
    {
        if (!out_x || !out_y || !out_z) return;
        *out_x = 0;
        *out_y = 0;
        // Sinusoidal bob: out_z = sin(CurrentWobbles * pi) * Amplitude
        *out_z = static_cast<int>(std::sin(CurrentWobbles * 3.14159) * 8.0);
    }

    // IDA 0x4CFB00 — ComputeVoxelMatrix: combined voxel render matrix
    float* ComputeVoxelMatrix(float* out, int key)
    {
        return ComputeVoxelTransform(out, key);
    }

    // IDA 0x4CCC80 — UpdateFootLocomotion: process foot movement within state
    void UpdateFootLocomotion()
    {
        if (!LinkedTo) return;
        // Handle ground-level movement for jumpjet when in Grounded state
        // Delegate to FootClass movement logic
    }

    // IDA 0x4CCB40 — ProcessLocomotionStep: single step of movement logic
    void ProcessLocomotionStep()
    {
        // Process one frame of movement for the current state
        if (CurrentState == State::Grounded)
    ...
    // IDA 0x4CCFD0 — ComputeMoveToPosition: calculate next position along path
    void ComputeMoveToPosition(CoordStruct* out)
    {
        if (!out) return;
        *out = DestinationCoords;
        // Apply speed and facing to calculate intermediate position
    }

    // IDA 0x4B6040 — UpdateMovementPosition: sync visual position with logical
    void UpdateMovementPosition()
    {
        if (!LinkedTo) return;
        // Update the visual rendering position based on:
        // - Logical cell position
        // - CurrentHeight for Z offset
        // - Wobble/bob animation offset
    }

    // IDA 0x514D90 — SetMovementTarget: establish movement goal coordinates
    void SetMovementTarget(CoordStruct target)
    {
        DestinationCoords = target;
        DestinationReached = false;
        if (CurrentState == State::Grounded || CurrentState == State::Hovering)
        {
            CurrentState = State::Ascending;
        }
    }

    // IDA 0x4B0C40 — SetWaypointTarget: set waypoint path target
    void SetWaypointTarget(CoordStruct target)
    {
        SetMovementTarget(target);
        // Additional waypoint path logic:
        // Store intermediate waypoints for multi-step path
    }

    // IDA 0x516E10 — TryMoveToAdjacentCell: attempt movement to neighboring cell
    bool TryMoveToAdjacentCell(int direction)
    {
        // Check if adjacent cell in given direction is passable
        // For jumpjets, most cells are passable (they fly over obstacles)
        // Only blocked by map edges and certain impassable terrain
        (void)direction;
        return CurrentState != State::Grounded; // Can always move when airborne
    }

    // IDA 0x4B4920 — IsAtDestination: check if reached target coordinates
    bool IsAtDestination()
    {
        if (!LinkedTo) return true;
        int dx = DestinationCoords.X - LinkedTo->location.X;
        int dy = DestinationCoords.Y - LinkedTo->location.Y;
        int dz = DestinationCoords.Z - LinkedTo->location.Z;
        return (dx * dx + dy * dy + dz * dz) < 256;
    }

    // IDA 0x55ABB0 — CheckState: validate and clamp current state
    void CheckState()
    {
        if (static_cast<int32_t>(CurrentState) < 0 ||
            static_cast<int32_t>(CurrentState) > static_cast<int32_t>(State::Unknown))
        {
            CurrentState = State::Grounded;
        }
    }

    // IDA 0x729B40 — ComputeTurretTransform: turret rotation matrix
    void* ComputeTurretTransform(float* out)
    {
        if (!out) return nullptr;
        std::memset(out, 0, 16 * sizeof(float));
        out[0] = out[5] = out[10] = out[15] = 1.0f;
    ...
    // IDA 0x729E50 — ComputeBounceHeight: calculate bounce offset for landing
    int ComputeBounceHeight()
    {
        // When descending and about to land, calculate compression bounce
        if (CurrentState == State::Descending && CurrentHeight < 20)
            return static_cast<int>(CurrentHeight * -0.5); // Small bounce
        return 0;
    }
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }69ED70

    // IPiggyback
    virtual HRESULT __stdcall Begin_Piggyback(ILocomotion* pointer) override { return S_OK; }         // 0x69EFE0
    virtual HRESULT __stdcall End_Piggyback(ILocomotion** pointer) override { return S_OK; }          // 0x69F060
    virtual bool __stdcall Is_Ok_To_End() override { return false; }                                   // 0x69F0A0
    virtual HRESULT __stdcall Piggyback_CLSID(GUID* classid) override { return S_OK; }                // 0x69F0B0
    virtual bool __stdcall Is_Piggybacking() override { return false; }                                // 0x69F0D0

    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x69EC60
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x69EC80
    virtual bool __stdcall Process() override { return false; }                                        // 0x69EE60
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x69EF20
...
public:
    ...
    // IPiggyback
    virtual HRESULT __stdcall Begin_Piggyback(ILocomotion* pointer) override { return S_OK; }         // 0x7180E0
    virtual HRESULT __stdcall End_Piggyback(ILocomotion** pointer) override { return S_OK; }          // 0x718170
    virtual bool __stdcall Is_Ok_To_End() override { return false; }                                   // 0x7181E0
    virtual HRESULT __stdcall Piggyback_CLSID(GUID* classid) override { return S_OK; }                // 0x718200
    virtual bool __stdcall Is_Piggybacking() override { return false; }                                // 0x718220

    // ILocomotion overrides
    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x718060
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x718070
    virtual bool __stdcall Process() override { return false; }                                        // 0x718240
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x7186E0
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }718010
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }728B40

    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x728A10
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x728A30
    virtual bool __stdcall Process() override { return false; }                                        // 0x728CF0
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x7291A0
...
public:
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }5B19A0
    ...
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x5B1A00
...
public:
    ...
    virtual bool __stdcall Is_Moving() override { return false; }                                      // 0x4B5BC0
    virtual CoordStruct* __stdcall Destination(CoordStruct* out) override { return nullptr; }            // 0x4B5BD0
    virtual bool __stdcall Process() override { return false; }                                        // 0x4B5C60
    virtual void __stdcall Move_To(CoordStruct to) override { (void)to; }                          // 0x4B5E10
    ...
    virtual int __stdcall Drawing_Code() override { return 0; }                                    // 0x4B5BF0
    ...
    virtual HRESULT __stdcall Load(IStream* stream) override { return S_OK; }         // stub
    virtual HRESULT __stdcall Save(IStream* stream, int clear_dirty) override { (void)stream; (void)clear_dirty; return S_OK; }4B5B00
