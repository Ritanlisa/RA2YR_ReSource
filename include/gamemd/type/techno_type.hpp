...
public:
    ...
    DWORD align_2FC;
    double techTypeField_double_300;
    ...
    _GUID Locomotor;
    DWORD align_35C;
    double techTypeField_double_360;
    double techTypeField_double_368;
    double Weight;
    double PhysicalSize;
    double Size;
    double SizeLimit;
    ...
    bool techTypeFlag_CB4;
    TurretControl BarrelAnimData;
    bool techTypeFlag_CC8;
    uint8_t align_CC9;
    uint8_t align_CCA;
    uint8_t align_CCB;
    bool Repairable;
