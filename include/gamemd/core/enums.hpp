...
enum class AbstractFlags : unsigned
{
    None   = 0x0,
    Techno = 0x1,
    Object = 0x2,
...
enum class AIDifficulty : unsigned
{
    Hard   = 0,
    Normal = 1,
    Easy   = 2
...
enum class TriggerPersistence : unsigned
{
    Volatile       = 0,
    SemiPersistant = 1,
    Persistent     = 2
...
enum class TriggerEvent : unsigned
{
    None                         = 0x0,
    EnteredBy                    = 0x1,
    SpiedBy                      = 0x2,
...
enum class TriggerAction : unsigned
{
    None                          = 0x0,
    Win                           = 0x1,
    Lose                          = 0x2,
...
enum class SpotlightBehaviour : unsigned
{
    None   = 0,
    Sweep  = 1,
    Circle = 2,
...
enum class SpotlightFlags : unsigned
{
    None    = 0x0,
    NoColor = 0x1,
    NoRed   = 0x2,
...
enum class HealthState : unsigned
{
    Red    = 0,
    Yellow = 1,
    Green  = 2
...
enum class PsychicDominatorStatus : unsigned
{
    Inactive   = 0,
    FirstAnim  = 1,
    Fire       = 2,
...
enum class NukeFlashStatus : unsigned
{
    Inactive = 0,
    FadeIn   = 1,
    FadeOut  = 2
...
enum class MouseCursorType : unsigned
{
    Default           = 0x0,
    Move_N            = 0x1,
    Move_NE           = 0x2,
...
enum class RadBeamType : unsigned
{
    Temporal = 0,
    RadBeam  = 1,
    Eruption = 2
...
enum class SequenceFacing : unsigned
{
    N  = 0,
    NE = 1,
    E  = 2,
...
enum class VisualType : unsigned
{
    Normal     = 0,
    Indistinct = 1,
    Darken     = 2,
