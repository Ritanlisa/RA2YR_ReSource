...
{
public:
    static constexpr AbstractType kAbsID = AbstractType::Anim;
    ...
    virtual int Size() const override { return sizeof(AnimClass); }
    ...
    uint8_t             animField_196;
    uint8_t             animField_197;
    bool                IsPlaying;
    bool                IsFogged;
