...
CATEGORY_MAP = {
    ...
    "0x6c8c40": "get_ticks", "0x4355b0": "pack_rgb", "0x4a38d0": "stub",
    ...
    "0x473ce0": "stub", "0x535aa0": "ini_ctor", "0x535b30": "ccini_ctor",
...
# ============================================================
# Templates — positional params: p0, p1, p2, ...
...
def generate_re_impl(markers):
    out = ['// Auto-generated RE_* functions for hook DLL',
           '// Generated by gen_re_impl.py — params from actual function signature',
           '#include <windows.h>', '']
