...
| IDA 命名函数 | **9,101** (51.2% of 17,765) |
| IDA 类成员命名 | **7,576** (76.2% of 9,936) |
| IDA 全局函数命名 | **1,525** (19.5% of 7,829) |
...
### Options_Screen 控件ID对照表 (OptionsScreenSave @ 0x55FAA0)
...
### CampaignScreen 通用对话框架构 (0x60D380)
